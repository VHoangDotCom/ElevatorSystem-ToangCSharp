namespace ElevatorSystem.Admin.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ElevatorSystem.Admin.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ElevatorSystem.Admin.Models.ApplicationDbContext context)
        {
            ...
            {
                new Discount{Name="Company Anniversary",Description="On the occasion of the Company's Anniversary, we have a promotion for all products and services of the company.",DiscountPercent=20,IsActivated=false,CreatedAt=DateTime.Now,ModifiedAt=DateTime.Parse("2022-09-01"),DeletedAt=DateTime.Parse("2022-09-01")},
                new Discount{Name="Black Friday",Description="On the occasion of the Black Friday, we have a promotion for all products and services of the company.",DiscountPercent=20,IsActivated=false,CreatedAt=DateTime.Now,ModifiedAt=DateTime.Parse("2022-09-01"),DeletedAt=DateTime.Parse("2022-09-01")},
                new Discount{Name="International Elevator Day",Description="On the occasion of the International Elevator Day, we have a promotion for all products and services of the company.",DiscountPercent=20,IsActivated=false,CreatedAt=DateTime.Now,ModifiedAt=DateTime.Parse("2022-09-01"),DeletedAt=DateTime.Parse("2022-09-01")},
                new Discount{Name="International Women's Day",Description="On the occasion of the Women's Day, we have a promotion for all products and services of the company.",DiscountPercent=20,IsActivated=false,CreatedAt=DateTime.Now,ModifiedAt=DateTime.Parse("2022-09-01"),DeletedAt=DateTime.Parse("2022-09-01")},
            };
            discounts.ForEach(s => context.Discounts.Add(s));
            context.SaveChanges();
